-- Fix: Check which table exists and create data in the correct one
...
WHERE table_schema = 'public'
  AND (table_name = 'AgentMetrics' OR table_name = 'agent_metrics');

-- Insert into the lowercase table name (which Prisma is actually using)
